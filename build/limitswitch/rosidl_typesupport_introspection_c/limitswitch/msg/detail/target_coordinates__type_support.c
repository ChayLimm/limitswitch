...
#include <stddef.h>
#include "limitswitch/msg/detail/target_coordinates__rosidl_typesupport_introspection_c.h"
#include "limitswitch/msg/rosidl_typesupport_introspection_c__visibility_control.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  limitswitch__msg__TargetCoordinates__init(message_memory);
}

void TargetCoordinates__rosidl_typesupport_introspection_c__TargetCoordinates_fini_function(void * message_memory)
{
  limitswitch__msg__TargetCoordinates__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember TargetCoordinates__rosidl_typesupport_introspection_c__TargetCoordinates_message_member_array[3] = {
  {
    "rail",  // name
    ...
    offsetof(limitswitch__msg__TargetCoordinates, rail),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(limitswitch__msg__TargetCoordinates, front_left),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(limitswitch__msg__TargetCoordinates, front_right),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers TargetCoordinates__rosidl_typesupport_introspection_c__TargetCoordinates_message_members = {
  "limitswitch__msg",  // message namespace
  "TargetCoordinates",  // message name
  3,  // number of fields
  sizeof(limitswitch__msg__TargetCoordinates),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_limitswitch
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, limitswitch, msg, TargetCoordinates)() {
