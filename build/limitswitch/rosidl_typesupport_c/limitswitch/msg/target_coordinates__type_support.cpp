...
#include "limitswitch/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _TargetCoordinates_type_support_symbol_names_t _TargetCoordinates_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, limitswitch, msg, TargetCoordinates)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, limitswitch, msg, TargetCoordinates)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_limitswitch
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, limitswitch, msg, TargetCoordinates)() {
  return &::limitswitch::msg::rosidl_typesupport_c::TargetCoordinates_message_type_support_handle;
}
